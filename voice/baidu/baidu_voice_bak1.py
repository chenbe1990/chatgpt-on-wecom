...
class BaiduVoice(Voice):
    def __init__(self):
        try:
            curdir = os.path.dirname("C:\\Users\\Administrator\\PycharmProjects\\chatgpt-on-wechat")
...
if __name__ == "__main__":
    ...
    baiduvoice.voiceToText("C:\\Users\\Administrator\\PycharmProjects\\chatgpt-on-wechat\\tmp\\1aootiCL-m_FETvf3lPsueJvNIwgLW6_nc2coahlBjC0apljEojCMf1CGLayp2-tZ - 副本.wav")